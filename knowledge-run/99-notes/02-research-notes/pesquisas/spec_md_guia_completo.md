...
- _Exemplo:_ "O sistema deve permitir login via Google."
- _Exemplo:_ "O usuário deve conseguir exportar relatórios em PDF."
...
- _Exemplo:_ "Um usuário só pode deletar um comentário se ele for o autor ou for um administrador."
