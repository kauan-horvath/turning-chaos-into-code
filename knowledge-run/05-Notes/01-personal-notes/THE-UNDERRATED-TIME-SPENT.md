...
> **The Challenge:** It took me an hour to design and implement this relative path logic. The real difficulty wasn't the syntax, but mastering **Directory Navigation**—understanding exactly when to "exit" a folder to reach the root before "entering" a new destination.
...
As shown in the showcase above, "small" adjustments are rarely simple. Even with AI assistance for the heavy lifting, the process of **thinking, designing, and mapping** these paths consumed an hour of my time. The struggle to visualize the folder hierarchy proved that even basic infrastructure requires deep focus.
